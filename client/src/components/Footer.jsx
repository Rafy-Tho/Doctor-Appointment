  ...
  return (
    <footer className=" py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-16">
        <div className="lg:col-span-3 space-y-6">
          <a href="https://prebuiltui.com" className="block">
            <img className="dark:invert" src={assets.logo} alt="" />
          </a>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <input
              ...
              className="border border-slate-500 px-3 py-3 rounded-md w-full sm:flex-1 sm:max-w-xs placeholder:text-sm placeholder:font-light focus:outline-none focus:ring-1 focus:ring-gray-600"
            />
            <button className=" px-5 py-3 rounded-md border border-slate-500 text-sm hover:bg-gray-700 transition-colors hover:text-slate-300">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 md:mt-16 pt-6 border-t border-neutral-700 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className=" text-xs sm:text-sm order-2 md:order-1">
